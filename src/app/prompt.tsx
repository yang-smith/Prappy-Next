...
export function PromptKuakua(question: string): string {
    const prompt_kuakua = `
        ####背景
        ...
        `
    return prompt_kuakua
}

export function PromptRainbow(question: string[]): string {
    const prompt_rainbow = `
        ####背景
